...
define(["jquery", "gl-matrix", "util", "webgl-debug",
    ...
    (function ($, glmatrix, util, WebGLDebugUtils, Program, shaders, Animation, HtmlController, Triangle, Cube, Band) {
        ...
        $(document).ready((function () {
            ...
            try {
                ...
                var MyScene = function (gl, transformation) {
                    ...
                    this.bandWireframe = new Band(gl, { radius:0.4, height:0.2, segments:50, "asWireframe":true });
...
//                    gl.clearColor(0.7, 0.7, 0.7, 1.0);
                    ...
                    if (this.drawOptions["Band Wireframe"]) {
                        this.bandWireframe.draw(gl, this.prog_black);
                    }
                };
