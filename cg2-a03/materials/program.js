...
define(["../utils/util"],
    (function (util) {
        ...
        var Program = function (gl, vertexShaderSource, fragmentShaderSource, prog_name) {
        ...
        Program.prototype.setUniform = function (name, type, value, showWarning) {
            ...
            if (location == null) {
                if (showWarning) {
                    window.console.log("WARNING: uniform variable " + name + " not used in shader. ["+this.prog_name+"]");
                }
            } else {
...
//            console.log("set "+textureUnit+" texture: " +uniformName + " "+texture);
            ...
            if (textureUnit < 0 || textureUnit >= max) {
                console.error("ERROR: setTexture(): texture unit " + textureUnit + " out of range [0 ... " + max - 1) + "]";
                return false;
            }
            ...
            if (location === null || location < 0) {
                console.error("uniform sampler " + uniformName + " not used in shader. ["+this.prog_name+"]");
                return;
            }

//            window.console.log("using texture unit "+textureUnit+" for sampler "+uniformName);
