    ...
    (function ($) {
        ...
        var HtmlController = function (scene, lightAnimation) {
            ...
            var updateParams = function () {
                ...
                // set animation speed
                lightAnimation.customSpeed = parseFloat($("#lightanim_Speed").val());

                // set cloud intensity
                scene.cloudsIntensity = parseFloat($("#cloud_Intensity").val());

                // set day texture
                scene.month = parseInt($("#texture_Month option:selected").val());
            ...
            $("#lightanim_Toggle").attr("checked", true);
            $("#lightanim_Speed").attr("value", 24);
            $("#cloud_Intensity").attr("value", 1.5);
            $("#texture_Month option[value='3']").attr('selected',true);
